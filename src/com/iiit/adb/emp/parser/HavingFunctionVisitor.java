...
public class HavingFunctionVisitor implements SelectVisitor, ExpressionVisitor{
	private ArrayList<HavingExpression> flist;
	
	public ArrayList<HavingExpression> getFunctionParams(Select select){
		flist = new ArrayList<HavingExpression>();
